...
class DataOfficerAllegation(db.Model):
    ...
    recc_finding = db.Column(db.String(2))
    recc_outcome = db.Column(db.String(32))
    final_finding = db.Column(db.String(2))
    final_outcome = db.Column(db.String(32))
    final_outcome_class = db.Column(db.String(20))
