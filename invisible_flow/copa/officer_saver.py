...
class OfficerSaver:
    ...
    def save_officer_to_csv(self, old_officer_data: pd.DataFrame, new_officer_data: pd.DataFrame):
        old_officer_demographics = self.split_officer_data(old_officer_data)
        self.save(old_officer_data, 'old_officer_allegation_data.csv')
        self.save(old_officer_demographics, 'old_officer_demographic_data.csv')

        new_officer_demographics = self.split_officer_data(new_officer_data)
        self.save(new_officer_data, 'new_officer_allegation_data.csv')
